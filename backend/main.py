...
# docker run -d -p 1521:1521 -e ORACLE_PASSWORD=abcd -v oracle-volume:/opt/oracle/oradata gvenzl/oracle-xe

# sqlldr system/abcd@localhost:1521/XEPDB1 control=soccer_matches.ctl